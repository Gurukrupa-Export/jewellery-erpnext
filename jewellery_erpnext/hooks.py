...
doc_events = {
    ...
    "Sales Order": {
        "after_mapping": "jewellery_erpnext.jewellery_erpnext.doc_events.sales_order.after_mapping",
...
override_doctype_class = {
    ...
    "Stock Reconciliation":["jewellery_erpnext.jewellery_erpnext.doctype.stock_reconciliation_template.stock_reconciliation_template_utils.CustomStockReconciliation","jewellery_erpnext.jewellery_erpnext.customization.stock_reconciliation.stock_reonciliation.CustomStockReconciliation"],
